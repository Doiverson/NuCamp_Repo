...
-- A: Create a new junction table, say employee_expertise, with columns employee_id and category_id. Both columns are foreign keys referencing the employees and categories tables respectively. This allows recording multiple categories of expertise for each employee.
...
INSERT INTO employees_categories (employee_id, category_id)
SELECT employees.employee_id, categories.category_id
FROM employees, categories
WHERE employees.city = 'London' AND categories.category_name = 'Dairy Products';
